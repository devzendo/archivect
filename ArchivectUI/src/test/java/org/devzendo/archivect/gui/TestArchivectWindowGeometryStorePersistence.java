...
import org.devzendo.archivect.prefs.DefaultArchivectPrefs;
 ...
 *
 */
public final class TestArchivectWindowGeometryStorePersistence {
    ...
    public void setUp() throws IOException {
        ...
        final ArchivectPrefs prefs = new DefaultArchivectPrefs(mTempFile.getAbsolutePath());
    ...
    public void testGetStoredGeometry() {
        ...
        Assert.assertEquals(WINDOW_GEOMETRY, persistence.getWindowGeometry(FOO));
    }
}
